package jp.co.dk.datastoremanager.core.property;
	...
	public DataStoreParameter getDefaultDataStoreParameter() throws DataStoreManagerException {
		...
		switch (dataStoreKind) {
			case ORACLE:
				...
				return new jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter(DataStoreKind.ORACLE, DataBaseDriverConstants.ORACLE, oracleurl, oracleuser, oraclepassword);
			...
			case MYSQL:
				...
				return new jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter(DataStoreKind.MYSQL, DataBaseDriverConstants.MYSQL, mysqlurl, mysqluser, mysqlpassword);
			...
			case POSTGRESQL:
				...
				return new jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter(DataStoreKind.POSTGRESQL, DataBaseDriverConstants.POSTGRESSQL, postgresqlurl, postgresqluser, postgresqlpassword);
			...
			case NEO4J:
				...
				if (neo4juser == null || neo4juser.equals("")) {
					return new jp.co.dk.datastoremanager.core.gdb.DataBaseAccessParameter(DataStoreKind.NEO4J, DataBaseDriverConstants.NEO4J, neo4jurl);
				} else {
					return new jp.co.dk.datastoremanager.core.gdb.DataBaseAccessParameter(DataStoreKind.NEO4J, DataBaseDriverConstants.NEO4J, neo4jurl, neo4juser, neo4jpassword);
				}
			default :
