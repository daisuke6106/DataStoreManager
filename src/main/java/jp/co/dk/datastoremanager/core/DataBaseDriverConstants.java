...
import static jp.co.dk.datastoremanager.core.message.DataStoreManagerMessage.DATASTORE_KIND_VALUE_IS_FAILE;
...
public enum DataBaseDriverConstants {
	...
	ORACLE("jdbc:oracle:thin:@servername:databasename", "oracle.jdbc.driver.OracleDriver", DataStoreKind.ORACLE, new DataStoreFactory(){
		...
		public DataStore createDataStore(DataStoreParameter dataStoreParameter) {
			return new jp.co.dk.datastoremanager.core.rdb.oracle.OracleDataBaseDataStore((jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter)dataStoreParameter);
		}
	}),
	/** MYSQL */
	MYSQL("jdbc:mysql://servername/databasename", "com.mysql.jdbc.Driver", DataStoreKind.MYSQL, new DataStoreFactory(){
		@Override
		public DataStore createDataStore(DataStoreParameter dataStoreParameter) {
			return new jp.co.dk.datastoremanager.core.rdb.mysql.MySqlDataBaseDataStore((jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter)dataStoreParameter);
		}
	}),
	/** POSTGRESSQL */
	POSTGRESSQL("jdbc:postgresql://servername/databasename", "org.postgresql.Driver", DataStoreKind.POSTGRESQL, new DataStoreFactory(){
		@Override
		public DataStore createDataStore(DataStoreParameter dataStoreParameter) {
			return new jp.co.dk.datastoremanager.core.rdb.postgressql.PostgresSqlDataBaseDataStore((jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter)dataStoreParameter);
		}
	}),
	/** NEO4J */
	NEO4J("jdbc:neo4j://servername", "org.neo4j.jdbc.Driver", DataStoreKind.NEO4J, new DataStoreFactory(){
		@Override
		public DataStore createDataStore(DataStoreParameter dataStoreParameter) {
			return new jp.co.dk.datastoremanager.core.gdb.DataBaseDataStore((jp.co.dk.datastoremanager.core.gdb.DataBaseAccessParameter)dataStoreParameter);
		}
	}),
	;
