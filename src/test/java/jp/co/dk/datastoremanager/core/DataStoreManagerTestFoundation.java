...
public class DataStoreManagerTestFoundation extends TestCaseTemplate{
	...
	protected jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter getAccessableDataBaseAccessParameterORACLE() throws DataStoreManagerException {
		return new jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter(DataStoreKind.ORACLE, DataBaseDriverConstants.ORACLE, "jdbc:oracle:thin:@192.168.1.151:1521:XE", "usr01", "12345");
	}
	 ...
	 * @throws DataStoreManagerException 引数が不足していた場合
	 */
	protected jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter getAccessFaileDataBaseAccessParameterORACLE() throws DataStoreManagerException {
		return new jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter(DataStoreKind.ORACLE, DataBaseDriverConstants.ORACLE, "255.255.255.255:3306", "test_user", "123456");
	}
	 ...
	 * @throws DataStoreManagerException 引数が不足していた場合
	 */
	protected jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter getAccessFaileDataBaseAccessParameterMYSQL() throws DataStoreManagerException {
		return new jp.co.dk.datastoremanager.core.rdb.DataBaseAccessParameter(DataStoreKind.MYSQL, DataBaseDriverConstants.MYSQL, "255.255.255.255:3306", "test_user", "123456");
	}
	 ...
	 * @throws DataStoreManagerException 引数が不足していた場合
	 */
	protected jp.co.dk.datastoremanager.core.gdb.DataBaseAccessParameter getAccessFaileDataBaseAccessParameterGDB() throws DataStoreManagerException {
		return new jp.co.dk.datastoremanager.core.gdb.DataBaseAccessParameter(DataStoreKind.NEO4J, DataBaseDriverConstants.NEO4J, "255.255.255.255:7474");
	}
